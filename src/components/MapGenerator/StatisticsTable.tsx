	...
	return (
		<table>
			...
			<tbody>
				<tr>
					<td>
						<img alt="Castle" src="/design/icon_castle.png" /> Players
					</td>
					<td>{players}</td>
					<td>-</td>
				</tr>
				<tr>
					<td>
						<img alt="Hut" src="/design/icon_hut.png" /> Trees
					</td>
				...
				<tr>
					<td>
						<img alt="Hut" src="/design/icon_hut.png" /> Granite
					</td>
				...
				<tr>
					<td>
						<img alt="Mountain" src="/design/icon_mine.png" /> Coal
					</td>
					<td>{coal}</td>
				...
				<tr>
					<td>
						<img alt="Mountain" src="/design/icon_mine.png" /> Iron ore
					</td>
					<td>{ironOre}</td>
				...
				<tr>
					<td>
						<img alt="Mountain" src="/design/icon_mine.png" /> Gold
					</td>
					<td>{gold}</td>
				...
				<tr>
					<td>
						<img alt="Mountain" src="/design/icon_mine.png" /> Granite
					</td>
					<td>{granite}</td>
