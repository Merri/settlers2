			...
			<section className="generator-compatibility">
				...
				<dl>
					<dt className="generator-compatibility__title">
						<label>
							<input
								name="compatibility"
								type="radio"
								value="return-to-the-roots"
								checked={returnToTheRoots}
					...
					<dd className="generator-compatibility__description">
						<p>
							RttR has less limitations with map sizes, numbers of players allowed and it also doesn't bug
							when building roads through the edges of a map. Building harbors is not an issue. However
							RttR doesn't currently support all of the textures that are usable in the original game.
						</p>
						<ul>
					...
					<dd className="generator-compatibility__description">
						<p>
							Roman Campaign is the least restrictive mode in the original game, however playing a map in
							this mode needs some extra work. RTX scripts must be self customized in order to be able to
							play a map.
						</p>
						<ul>
							...
							<li>
								Longest map title: 24 characters (Greenland) or 23 characters (Wasteland and Winter
								World)
							</li>
						</ul>
					</dd>
					...
					<dd className="generator-compatibility__description">
						<p>
							World Campaign allows setting the leaders right into the map file itself. Replacing a map is
							easy enough as there is no scripting support.
						</p>
						<ul>
							<li>Biggest map allowed: 256 x 256</li>
							<li>Maximum number of players: 7</li>
					...
					<dt className="generator-compatibility__title">
						<label>
							<input
								name="compatibility"
								type="radio"
								value="unlimited-play"
								checked={unlimitedPlay}
								onChange={this.handleChange}
							/>
					...
					<dd className="generator-compatibility__description">
						<p>
							Unlimited Play is the easiest mode to use in the original game: just throw SWD maps to the
							WORLD folder and you're ready to go.
						</p>
						<ul>
							<li>Biggest map allowed: 256 x 256</li>
							<li>Maximum number of players: 7</li>
					...
					<dd className="generator-compatibility__description">
						<p>
							This mode generates maps that have mostly the same limitations as the original map editor.
						</p>
						<ul>
							<li>Biggest map allowed: 256 x 256</li>
							<li>Maximum number of players: 7</li>
